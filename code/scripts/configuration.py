...
class Config:
    ...
    MODEL_PATH2 = "/home/sumiya/signate/student2022/code/pretrain/deverta_v3_large_5fold3/compe2022-deberta-v3-large/"
    # ベースとなるディレクトリパスの指定
    PATH = "/home/sumiya/signate/student2022/code"
    CURRENT_PATH = PATH
    # パラメータ設定
    target = "jobflag"              # 目的変数
    num_class = 4                   # クラス数
